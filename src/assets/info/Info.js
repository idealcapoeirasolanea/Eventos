...
export const info = {
  ...
  position: '1º Festival do Ideal Capoeira Solânea',
  ...
  socials: [
    {
      link: 'https://www.facebook.com/profile.php?id=100041545959580', // this should be https://yourname.com/resume.pdf once you've deployed
      icon: 'fa fa-facebook',
      label: 'facebook',
    },
    {
      link: 'https://www.instagram.com/ideal_capoeira_solanea/',
      icon: 'fa fa-instagram',
      label: 'instagram',
    },
    {
      link: 'https://github.com/idealcapoeirasolanea',
      icon: 'fa fa-github',
      label: 'github',
    },
    {
      link: 'https://wa.me/83993822366?text=Queria%20saber%20mais%20sobre%20o%20evento?',
      icon: 'fa fa-whatsapp',
      label: 'whatsapp',
    },
